...
void mex_cineq5_max_func(int resc, mxArray *resv[], int argc, const mxArray *argv[]) {
  ...
  casadi_real* res[1] = {0};
  if (argc>6) mexErrMsgIdAndTxt("Casadi:RuntimeError","Evaluation of \"cineq5_max_func\" failed. Too many input arguments (%d, max 6)", argc);
  ...
  --resc;
  res[0] = w+185;
  i = cineq5_max_func(arg, res, iw, w+225, 0);
...
casadi_int main_cineq5_max_func(casadi_int argc, char* argv[]) {
  ...
  flag = cineq5_max_func(arg, res, iw, w+225, 0);
  if (flag) return flag;
  r = w+185;
