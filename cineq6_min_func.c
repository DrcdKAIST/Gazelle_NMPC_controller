...
/* cineq6_min_func:(i0[180],i1,i2,i3,i4,i5)->(o0[2]) */
...
CASADI_SYMBOL_EXPORT casadi_int cineq6_min_func_n_in(void) { return 6;}
...
void mex_cineq6_min_func(int resc, mxArray *resv[], int argc, const mxArray *argv[]) {
  ...
  casadi_real* res[1] = {0};
  if (argc>6) mexErrMsgIdAndTxt("Casadi:RuntimeError","Evaluation of \"cineq6_min_func\" failed. Too many input arguments (%d, max 6)", argc);
  ...
  --resc;
  res[0] = w+185;
  i = cineq6_min_func(arg, res, iw, w+187, 0);
...
casadi_int main_cineq6_min_func(casadi_int argc, char* argv[]) {
  ...
  flag = cineq6_min_func(arg, res, iw, w+187, 0);
  if (flag) return flag;
  r = w+185;
