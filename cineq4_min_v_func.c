...
void mex_cineq4_min_v_func(int resc, mxArray *resv[], int argc, const mxArray *argv[]) {
  ...
  casadi_real* res[1] = {0};
  if (argc>3) mexErrMsgIdAndTxt("Casadi:RuntimeError","Evaluation of \"cineq4_min_v_func\" failed. Too many input arguments (%d, max 3)", argc);
  ...
  --resc;
  res[0] = w+182;
  i = cineq4_min_v_func(arg, res, iw, w+222, 0);
...
casadi_int main_cineq4_min_v_func(casadi_int argc, char* argv[]) {
  ...
  flag = cineq4_min_v_func(arg, res, iw, w+222, 0);
  if (flag) return flag;
  r = w+182;
